    ...
    <div>
        <div>
            <x-filament::section>
                ...
                <x-filament::button wire:click="cariPeriode">
                    Cari
                </x-filament::button>

                <x-filament::button type="button" color="success" onclick="window.print();">
                    Print
                </x-filament::button>
            </x-filament::section>
        </div>
                                ...
                                <td colspan="2">
                                    <div id="contentBox" style="margin:0px auto; width:100%">
                                        <div id="column1" style="float:left; margin:0; width:50%;">
                                            <b>NAMA : </b> {{ $this->record->nama_pegawai }}
                                        </div>
                                ...
                                <td colspan="2">
                                    <div id="contentBox" style="margin:0px auto; width:100%">
                                        <div id="column1" style="float:left; margin:0; width:50%;">
                                            <div id="contentBox" style="margin:0px auto; width:100%">
                                                <div id="column2"
                                                    style="float:left; margin:0;width:50%;text-align: start;">
                                                    GAJI POKOK
                                                </div>
                                                <div id="column2"
                                                    style="float:left; margin:0;width:50%;text-align: end; padding-right: 10px">
                                    ...
                                    <div id="contentBox" style="margin:0px auto; width:100%">
                                        ...
                                        <div id="contentBox" style="margin:0px auto; width:100%">
                                            <div id="column1" style="float:left; margin:0; width:50%;">
                                                <div id="contentBox" style="margin:0px auto; width:100%">
                                                    <div id="column2"
                                                        style="float:left; margin:0;width:33%;text-align: start;">
                                                        ASURANSI
                                                    </div>
                                                    <div id="column2"
